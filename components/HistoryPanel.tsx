...
export const HistoryPanel: React.FC<HistoryPanelProps> = ({ history, onItemClick }) => {
    return (
        <aside className="w-full bg-gray-900/70 backdrop-blur-sm border-t border-gray-700/50 p-4 mt-auto">
            <h2 className="text-xl font-bold text-gray-100 mb-4 px-2">Analysis History</h2>
